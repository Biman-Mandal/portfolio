...
export default function ContactSection({ contact }) {
  ...
  return (
    <section id="contact" className="section alt" style={{ borderTop: "1px solid var(--line)", background: "var(--bg-alt)" }}>
      ...
      <div className="contact-container" style={{ display: "flex", flexWrap: "wrap", gap: "2.5rem", justifyContent: "center", alignItems: "stretch", maxWidth: "1000px", margin: "0 auto" }}>
        
        {/* Left side: Interactive Action Cards with Brand Icons */}
        <div className="info-panel" style={{ flex: "1 1 400px", display: "flex", flexDirection: "column", gap: "1.25rem", justifyContent: "center", padding: "1.5rem", background: "transparent", border: "none", boxShadow: "none" }}>
          ...
          {email && (
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                <span style={{ fontSize: "11px", fontWeight: 700, color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Email Me</span>
                <span style={{ fontSize: "16px", fontWeight: 600, color: "var(--ink)", wordBreak: "break-all" }}>{email}</span>
              </div>
            </a>
          )}
          ...
          {phone && (
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                <span style={{ fontSize: "11px", fontWeight: 700, color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Call Me</span>
                <span style={{ fontSize: "16px", fontWeight: 600, color: "var(--ink)" }}>{phone}</span>
              </div>
            </a>
          )}
          ...
          {whatsappNumber && (
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                <span style={{ fontSize: "11px", fontWeight: 700, color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>WhatsApp</span>
                <span style={{ fontSize: "16px", fontWeight: 600, color: "var(--ink)" }}>Chat on WhatsApp</span>
              </div>
            </a>
          )}
          ...
          {location && (
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                <span style={{ fontSize: "11px", fontWeight: 700, color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Location</span>
                <span style={{ fontSize: "16px", fontWeight: 600, color: "var(--ink)" }}>{location}</span>
              </div>
            </a>
          )}
      ...
      {contact.map_embed_url && (
        <iframe className="map reveal reveal-delay-2" src={contact.map_embed_url} loading="lazy" referrerPolicy="no-referrer-when-downgrade" style={{ width: "100%", height: "350px", border: "0", marginTop: "3rem", borderRadius: "16px", boxShadow: "var(--card-shadow)" }} />
      )}
    </section>
  );
}
